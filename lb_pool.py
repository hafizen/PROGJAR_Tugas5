...
class BackendList:
    def __init__(self):
        self.servers = []
        self.servers.append(('172.19.0.2', 9002))
        self.servers.append(('172.19.0.2', 9003))
        self.servers.append(('172.19.0.2', 9004))
        self.servers.append(('172.19.0.2', 9005))
        self.current = 0
...
class Server:
    def __init__(self, portnumber: int):
        ...
        self.socket.bind(('172.19.0.2', portnumber))
